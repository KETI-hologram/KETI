...
out_data = {
    ...
    'width': bpy.data.objects['Camera'].data.sensor_width,
    'height': bpy.data.objects['Camera'].data.sensor_height,
    'focal' : bpy.data.objects['Camera'].data.lens,
}
...
b_empty.rotation_euler = np.array([ANGLE, 0, 0])
